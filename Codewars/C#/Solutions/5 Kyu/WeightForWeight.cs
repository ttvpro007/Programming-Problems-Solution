...
namespace Codewars.Solutions._5_Kyu
{
    ...
    ///ordering) and not numbers: 100 is before 180 because its "weight" (1) is less than the one of 180 
    ///(9) and 180 is before 90 since, having the same "weight" (9), it comes before as a string.
    ///
