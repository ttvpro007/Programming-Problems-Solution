...
namespace Codewars.Solutions._5_Kyu
{
    ...
    ///story, you may have correctly guessed that they didn't exactly follow through the original 
    ///idea.
    ///
    ...
    ///For more info, browse the Josephus Permutation page on wikipedia; related kata: Josephus 
    ///Survivor.This problem takes its name by arguably the most important event in the life of the 
    ///ancient historian Josephus: according to his tale, he and his 40 soldiers were trapped in a 
    ///cave by the Romans during a siege.
    ///
    ///Refusing to surrender to the enemy, they instead opted for mass suicide, with a twist: they 
    ///formed a circle and proceeded to kill one man every three, until one last man was left (and 
    ///that it was supposed to kill himself to end the act).
