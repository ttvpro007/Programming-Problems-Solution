...
namespace Codewars.Solutions._6_Kyu
{
    class TheSupermarketQueue
    {
        ...
        ///The front person in the queue(i.e.the first element in the array/list) proceeds to a till as soon as 
        ///it becomes free.
        ///N.B.You should assume that all the test input will be valid, as specified above.
        ///
        ///P.S.The situation in this kata can be likened to the more-computer-science-related idea of a thread 
        ///pool, with relation to running multiple processes at the same time: 
