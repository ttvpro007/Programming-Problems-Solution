#pragma once
#include <vector>
///Two tortoises named A and B must run a race.A starts with an average speed of 720 feet per hour.Young B knows she runs 
///faster than A, and furthermore has not finished her cabbage.
///
...
{
public:
	static std::vector<int> race(int v1, int v2, int x10);
};